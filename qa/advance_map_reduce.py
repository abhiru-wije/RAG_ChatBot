...
question_prompt = PromptTemplate.from_template(
    template="""Use the following pieces of context to answer the user question at the end. If you do not have enough information to answer the question, please state that you do not have enough information.
    {context}
    Question: {question}
    Helpful answer:""",
)
